...
public class EncodePassword {
    ...
    public static void main(String[] args) {
        EncodePassword cpde = new EncodePassword();
        String abc = cpde.DecodePassBase64("MTIz");
        System.out.println(abc);
    }

    private String encodePassByBase64(String pass) {
    ...
    private String DecodePassBase64(String code) {
        try {
